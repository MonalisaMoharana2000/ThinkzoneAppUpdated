...
const CommonMonthlyReview = ({route, navigation}) => {
  ...
  useEffect(() => {
    ...
    Api.get(`getTransTtlQuizQuestions/${user[0].userid}/${topicId}`)
      .then(response => {
        console.log('review response--->', response.data[0].quizData);
        setReviewQuestions(response.data[0]?.quizData);
        setIsLoading(false);
      })
            ...
            {reviewQuestions.map((item, index) => (
              <TouchableOpacity
                ...
                style={{
                  ...
                  backgroundColor:
                    item.answer === item.correctAnswer ? '#A3D735' : '#FF9515',
                  marginLeft: 19,
                  // marginRight: 16,
                            ...
                            <View>
                              ...
                              <View style={{marginTop: 9}}>
                                <Text style={[styles.itemCorrect]}>
                                  ସଠିକ୍ ଉତ୍ତର:{' '}
                                  {reviewQuestions[header - 1].correctAnswer}
                                </Text>
                                <Text style={styles.item}>
                                  ଆପଣଙ୍କ ଉତ୍ତର :{' '}
                                  {reviewQuestions[header - 1].answer}
                      ...
                      <>
                        <View>
                              ...
                              <Text
                                style={[
                                  styles.item,
                                  {
                                    marginLeft: 5,
                                    backgroundColor:
                                      'A' === reviewQuestions[0].correctAnswer
                                        ? '#A3D735'
                              ...
                              <Text
                                style={[
                                  styles.item,
                                  {
                                    ...
                                    backgroundColor:
                                      'B' === reviewQuestions[0].correctAnswer
                                        ? '#A3D735'
                              ...
                              <Text
                                style={[
                                  styles.item,
                                  {
                                    ...
                                    backgroundColor:
                                      'C' === reviewQuestions[0].correctAnswer
                                        ? '#A3D735'
                              ...
                              <Text
                                style={[
                                  styles.item,
                                  {
                                    ...
                                    backgroundColor:
                                      'D' === reviewQuestions[0].correctAnswer
                                        ? '#A3D735'
                          ...
                          <View style={{marginTop: 25}}>
                            <Text style={[styles.itemCorrect]}>
                              ସଠିକ୍ ଉତ୍ତର : {reviewQuestions[0].correctAnswer}
                            </Text>
                            <Text style={styles.item}>
                              ଆପଣଙ୍କ ଉତ୍ତର : {reviewQuestions[0].answer}
                            </Text>
                          </View>
                        </View>
...
export default CommonMonthlyReview;
